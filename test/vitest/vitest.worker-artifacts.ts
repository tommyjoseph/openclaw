...
declare module "vitest" {
  export interface ProvidedContext {
    openclawCompiledSubprocesses?: VitestWorkerDescriptor;
  }
}
...
export function compiledSubprocessesPlugin(): Plugin {
  ...
  return {
    ...
    enforce: "pre",
    configureVitest({ vitest, project, experimental_defineCacheKeyGenerator }) {
      ...
      project.provide(VITEST_WORKER_ARTIFACTS_KEY, supplied);
